                ...
                stage('Test') {
                    steps {
                        container('podman') {
                            ...
                            sh 'podman run -it --rm localhost/$IMAGE_NAME R -e "library(\"babynames\");library(\"flextable\");library(\"ggplot2\");library(\"ggrepel\");library(\"ggthemes\");library(\"gt\");library(\"anytime\");library(\"freshr\");library(\"haven\");library(\"janitor\");library(\"knitr\");library(\"lmtest\");library(\"lubridate\");library(\"magrittr\");library(\"ncdf4\");library(\"nycflights13\");library(\"pacman\");library(\"png\");library(\"proftools\");library(\"usmap\");library(\"readxl\");library(\"rvest\");library(\"titanic\");library(\"viridis\");library(\"recessionShadingPackage2023\");library(\"UCSB.ECON.145.Package\")"'
